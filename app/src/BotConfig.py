...
replay_text_water = "Вот это ты молодец! Просто красавчик! Хоть когда в своей жизни не проебался."
...
answer_to_request = "Ваш запрос принят. В сокором времени с вам свяжится представитель сферы."


answer_to_dining_room = "Уже заказываем. Спасибо, за вклад в простарнство."
